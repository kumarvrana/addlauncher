  ...
  <form class="form" action="{{route('dashboard.postTelevisionForm')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="step">
            ...
            <div class="step-header">Television Display Options</div>
                ...
                @PHP
                        $ad_genre = array( 'Entertainment' => 'Entertainment', 'News' => 'News', 'Sports' => 'Sports' , 'Devotional' => 'Devotional', 'Kids' => 'Kids', 'Educational' => 'Educational', 'Food and drink' => 'Food and drink', 'Travel' => 'Travel');
