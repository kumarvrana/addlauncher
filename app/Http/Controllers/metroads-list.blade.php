            ...
            <div class="col-md-8">
              <div class="ad-sec">  
                ...
                <div class="row" id="table-results">
                    ...
                    @foreach($metro_ads as $key => $value)
                        @PHP
                            $image = $key.".jpg";
                        @ENDPHP
                    <div class="col-md-3">
                        <div class="owl-item active">
                            <div class="single-product">
                                ...
                                <div class="product-hover">
                                    <div class="add-to-cart"><a href="{{ route('frontend.getfrontMetroad', ['metroad' => $key]) }}"><span class="fa fa-shopping-cart"></span> View Details</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
