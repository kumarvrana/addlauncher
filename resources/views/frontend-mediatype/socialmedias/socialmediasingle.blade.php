						 	...
						 	<div class="page-cat-opt">
						 		...
						 		<div class="row">
						 			...
						 			@PHP
										...
										$session_key = 'socialmedias'.'_'.$passVariation[$i].'_'.$socialmediaad->id;
									...
									@ENDPHP
						 			...
						 			<div class="col-md-12">
						 				<div class="cat-opt-cart">
						 					<a href="{{route('socialmedia.addtocart', ['id' => $socialmediaad->id, 'variation' => $options])}}"><h3><span class="fa fa-star"></span>
