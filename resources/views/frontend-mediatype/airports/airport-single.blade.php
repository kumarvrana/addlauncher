...
@section('content')
        ...
        <div class="container-fluid"> <!-- container fluid 1 starts here -->
            <div class="row">
                ...
                @PHP
                   $variations = unserialize($airportad->display_options);
				   
				   $variation = array();
                   $price = array();
				   $passVariation = array();
                  foreach($airportprice as $options){
                ...
                <div class="col-md-9">
					...
					@if($variations)
							@foreach($variations as $loop)
								...
								background-image: url('../../images/display/airport/{{strtolower(str_replace(' ','_', $name[$i]))}}.png');
									} </style>
								<div class="col-md-3 col-sm-3 "> 
									<div class="pro-item"> 
										...
										$session_key = 'airports'.'_'.$passVariationname[$i].'_'.$airportad->id;
										$printsession = (array) Session::get('cart');
														
										@ENDPHP
										<div class="clearfix"> 
											<a class="glass" href="{{route('airport.addtocart', ['id' => $airportad->id, 'variation' => $options])}}"><span class="fa fa-star"></span>
