...
@section('content')
        ...
        <div class="container-fluid"> <!-- container fluid 1 starts here -->
            <div class="row">
                ...
                @PHP
                   $variations = unserialize($newspaperad->display_options);
				   
				   $variation = array();
                   $price = array();
				   $passVariation = array();
                  foreach($newspaperprice as $options){
						 	...
						 	<div class="page-cat-opt">
						 		...
						 		<div class="row">
						 			...
						 			@PHP
										...
										$session_key = 'newspapers'.'_'.$passVariation[$i].'_'.$newspaperad->id;
									...
									@ENDPHP
						 			...
						 			<div class="col-md-12">
						 				<div class="cat-opt-cart">
						 					<a href="{{route('newspaper.addtocart', ['id' => $newspaperad->id, 'variation' => $options])}}"><h3><span class="fa fa-star"></span>
