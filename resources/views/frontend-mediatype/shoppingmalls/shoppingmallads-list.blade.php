...
<section class="sec-banner">
     <div class="jumbotron jumbo-1 text-center">
         <h1><small>&emsp;ADVERTISE ON</small> <br><span>SHOPPINGMALLS</span></h1>
     </div>
</section>     
<section class="main-sec">
        <div class="container-fluid"> <!-- container fluid 1 starts here -->
          ...
          <div class="row cat-data">
                    <div class="col-md-12">
                        <div class="data-box">
                            <h2>About Shopping Mall advertising in India</h2>
                            ...
                            <h3>Advantages of Shopping Mall Advertisement</h3>
                            <ul>
