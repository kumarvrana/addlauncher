						 	...
						 	<div class="page-cat-opt">
						 		...
						 		<div class="row">
						 			...
						 			@PHP
										...
										$session_key = 'shoppingmalls'.'_'.$passVariation[$i].'_'.$shoppingmallad->id;
									...
									@ENDPHP
						 			...
						 			<div class="col-md-12">
						 				<div class="cat-opt-cart">
						 					<a href="{{route('shoppingmall.addtocart', ['id' => $shoppingmallad->id, 'variation' => $options])}}"><h3><span class="fa fa-star"></span>
