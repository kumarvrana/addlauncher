                        ...
                        <table>
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <h6 class="collapse">Forget Password?</h6>   
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <table>
                    <tr>
                        <td>
		                        ...
		                        <p>We've received a request to reset your password. If you didn't make the request, just ignore this email, you can reset your password using this link:</p>
		                        <br/>
		                        <div style="clear:both;"></div>
		                        <br/>
		                        <br/>
		                        <p style="text-align:center;">
		                            <a class="btn" href="{{ env('APP_URL') }}user/reset-password/{{$user->email}}/{{$code}}">Click here to reset your password &raquo;</a>
		                        </p>
		                        <br/>
		                        <br/>
		                        <p style="text-left;">
