...
<div class="page-sidebar">
	<div class="col-md-12 hidden-sm hidden-xs filter-side">
    ...
    <a href="{{Request::url()}}" class="btn thb-fill-style">Clear All Filters</a>
      ...
      <form id="airport-filter" class="filterform">
          ...
          <div id="collapse1" class="panel-collapse collapse in" >
            <div class="panel-body ">
                <div ng-app="rzSliderDemo">
                  <div ng-controller="MainCtrl" id="airport-nng" class="wrapper">
                    <article>
                      <input type="hidden" ng-model="checkClass" value="airport">
        ...
        <div class="panel panel-default panel-filter" id="panel2">
          <div class="panel-heading" >
            <a data-toggle="collapse" href="#collapse2"> <h4 class="panel-title"><span class="fa fa-caret-right g-side" aria-hidden="true"></span> Top Locations</h4></a>
          </div>
            ...
            <div class="panel-body">
              <ul class="list-group">
                ...
                <?php $loc_class= strtolower(str_replace(' ','_',$f_location->location)); ?>
                  <li class="list-group-item"><label class="airport"><input type="radio" class="adfilter" data-value="{{$loc_class}}" value="{{$f_location->location}}" name="locationFilter"> &ensp;{{$f_location->location}}</label></li>
                @endforeach
              </ul>
            </div>
          </div>
        ...
        <div class="panel panel-default panel-filter" id="panel3" style="display: none;">
          <div class="panel-heading" >
