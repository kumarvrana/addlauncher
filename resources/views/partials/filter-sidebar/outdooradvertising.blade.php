...
<div class="page-sidebar">
    ...
    <a href="{{Request::url()}}" class="btn thb-fill-style">Clear All Filters</a>
      ...
      <form id="outdoor-advertising-filter" class="filterform">
            ...
            <div class="panel-body">
              <ul class="list-group">
                ...
                <?php $loc_class= strtolower(str_replace(' ','_',$f_location->location)); ?>
                  <li class="list-group-item"><label class="billboard"><input type="radio" class="adfilter" data-value="{{$loc_class}}" value="{{$f_location->location}}" name="locationFilter"> &ensp;{{$f_location->location}}</label></li>
                @endforeach
              </ul>
            </div>
          </div>
