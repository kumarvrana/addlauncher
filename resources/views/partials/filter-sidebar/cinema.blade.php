...
<div class="page-sidebar">
  <div class="col-md-12 filter-side">
    ...
    <div class="filter-box">
      <form id="cinema-filter" class="filterform">
      <div class="panel-group">
        ...
        <div class="panel panel-default panel-filter" id="panel2">
          ...
          <a data-toggle="collapse" href="#collapse2">
            <h4 class="panel-title"><span class="fa fa-caret-right g-side" aria-hidden="true"></span> Top Location</h4></a>
          </div>
            ...
            <div class="panel-body">
              <ul class="list-group">
                ...
                <?php $loc_class= strtolower(str_replace(' ','_',$f_location->location)); ?>
                  <li class="list-group-item"><label class="cinema"><input type="radio" class="adfilter" data-value="{{$loc_class}}" value="{{$f_location->location}}" name="locationFilter"> &ensp;{{$f_location->location}}</label></li>
                @endforeach
              </ul>
            </div>
          </div>
