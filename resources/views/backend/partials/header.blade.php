<!--nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{route('product.mainCats')}}">Go To Frontend</a>
    </div>
   
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="{{ route('product.shoppingCart') }}">Orders<i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="badge"></span>
</a></li>
