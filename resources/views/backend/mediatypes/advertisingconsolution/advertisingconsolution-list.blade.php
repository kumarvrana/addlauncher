...
@section('title')
   Advertising Consolution Ad List | Ad Launcher
@endsection

@section('content')
     <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Advertising Consolution ads</h1>
    <div class="row">
        <div class="col-md-3">
            <a href="{{route('dashboard.getAdvertisingConsolutionForm')}}" type="button" class="btn btn-success">Add New Advertising Consolution Ad <i class="fa fa-plus" aria-hidden="true"></i>
</a>
        </div>
    </div>
    <hr>
