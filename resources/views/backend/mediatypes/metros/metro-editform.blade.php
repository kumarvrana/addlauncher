...
@section('content')
  ...
  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100">
    ...
    <form class="form" action="{{route('dashboard.postMetroForm')}}" method="post" enctype="multipart/form-data">
        <div class="step">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="metroline_id" required>
                    ...
                    <option <?php if($line->id == $metro->metroline_id) { echo " selected "; }?> value="{{$line->id}}">{{$line->line}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                <label for="station_name">Station Name:</label>
                <input type="text" id="station_name" name="station_name" class="form-control" placeholder="station name" value="{{$metro->station_name}}" required>
            </div>
            <div class="form-group">
                <label for="location">Location:</label>
                <input type="text" id="location" name="location" class="form-control" value="{{$metro->location}}" placeholder="location" required>
            </div>
            <div class="form-group">
                <label for="media">Media:</label>
                <input type="text" id="media" name="media" placeholder="media" value="{{$metro->media}}" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" min="1" max="10" id="units" name="units" placeholder="units" value="{{$metro->units}}" class="form-control" required>
                    </div>
                    <div class="col-sm-6">
                        <label for="faces">Face(s):</label>
                        <input type="number" min="1" max="10" id="faces" name="faces" placeholder="faces" value="{{$metro->faces}}" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="width" name="width" class="form-control" value="{{$metro->width}}" placeholder="" required>
                    </div>
                    <div class="col-sm-4">
                        <label for="height">Height(in ft.):</label>
                        <input type="text" id="height" name="height" class="form-control" value="{{$metro->height}}" placeholder="" required> 
                    </div>
                    <div class="col-sm-4">
                        <label for="area">Total Area (SQ Ft):</label>
                        <input type="text" id="area" name="area" class="form-control" value="{{$metro->area}}" placeholder="" required>
                    </div>
                </div>
            </div>
             <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="price" name="price" placeholder="Price" value="{{$metro->price}}" class="form-control" required>
                    </div>
                    <div class="col-sm-6">
                        <label for="discount_price">Discounted Price:</label>
                        <input type="text" id="discount_price" name="discount_price" placeholder="Discounted Price" value="{{$metro->discount_price}}" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
        ...
        <button type="submit" class="action submit btn btn-success">Edit Metro</button>    
    </form>
