...
@section('content')
  ...
  <form class="form" action="{{route('dashboard.postBillboardForm')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="step">
            ...
            <div class="step-header">Billboard Display Options</div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="form-group">
                        <label for="billboarddisplay">Do you want Full Ad Display On Billboard? </label>
                    ...
                    <div class="form-group">
                        <label for="billboardsnumber">Numbers Of Billboard Display this Ad? : </label>
