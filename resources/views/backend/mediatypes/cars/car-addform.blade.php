...
@section('content')
  ...
  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100">
    ...
    @if(count($errors) > 0 )
            ...
            @endif
  <form class="form" action="{{route('dashboard.postCarForm')}}" method="post" enctype="multipart/form-data">
        <div class="step">
        ...
        <div class="step">
            ...
            <div class="step-header">Car Display Options</div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="form-group">
                        <label for="bsdbusdisplayisplay">Do you want Full Ad Display On Car? </label>
                             
                    @foreach($bus_options as $key => $value)
                        <label class='checkbox-inline'><input data-label='Car Ad Display Options' onclick="addDomToPriceOptions('{{$value}}')" name='busdisplay[]' type='checkbox' value={{$key}}>{{$value}}</label>
                    @endforeach
                    ...
                    <div class="form-group">
                        <label for="busesnumber">Numbers Of Car Display this Ad? : </label>
                        <input class="form-control" type="text" name="carsnumber" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="busesnumber">Discount (%): </label>
                        <input class="form-control" type="text" name="cardiscount" placeholder="put an integer value for discount like 5 or 10">
                    </div>
                    </div>
                </div>
